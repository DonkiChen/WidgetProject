package test.widgetproject.widget.anim;
...
public class CircularAnim {
    ...
    public static class FullActivityBuilder {
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            try {
                ...
                // 若未设置时长，则以 PERFECT_MILLS 为基准根据水波扩散的距离来计算实际时间
                ...
                // 由于 thisActivity.startActivity() 会有所停顿，所以进入的水波动画应比退出的水波动画时间短才能保持视觉上的一致。
    ...
    /* 设置默认时长，设置充满 activity 的默认颜色或图片资源 */
